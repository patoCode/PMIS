...
/* FORM */
define('FORM_NOT_FOUND', 'FORMULARIO NO ENCONTRADO');
define('FORM_CREATED','FORMULARIO CREADO EXITOSAMENTE');
define('FORM_CREATION_ERROR','EL FORMULARIO NO PUEDE SER CREADO');
